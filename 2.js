        ...
        function D(e) {
          1 === (A += e) && 1 === e
            ? (window.addEventListener("popstate", S),
              a && window.addEventListener("hashchange", z))
            : 0 === A &&
              (window.removeEventListener("popstate", S),
              a && window.removeEventListener("hashchange", z));
        }
        var R = !1;
        var F = {
          length: t.length,
    ...
    function (e, t, n) {
      ...
      function g(e) {
        ...
        return (
          ...
          -1 !== H.indexOf("hover") &&
            ((U.onMouseOver = B), (U.onMouseOut = I)),
          l.a.createElement(
            l.a.Fragment,
            null,
            l.a.createElement(m, { ref: x }, Object(c.cloneElement)(z, U)),
            l.a.createElement(
              h.a,
              Object(r.a)({}, w, {
            ...
            l = {
              ...
              forceUpdate: function () {
                if (!c) {
                  ...
                  if (be(t, n)) {
                    (a.rects = {
                      reference: me(t, z(n), "fixed" === a.options.strategy),
                      popper: g(n),
                    }),
                      (a.reset = !1),
            ...
            var r = E(),
              ...
              c = Object(w.useCallback)(function (e) {
                ...
                (i.current = new $(e, function () {
                  var e = !1;
                  o.current &&
                    (e = z.fn(o.current, i.current.getAnimatedValue())),
                    (o.current && !1 !== e) || r();
                })),
                  t && t.detach();
              }, []);
          ...
          var f = (function e(n, c, l, f, d) {
            ...
            if (0 < (B = U.length)) {
              if (
                ((R = c),
                0 < N &&
                  void 0 !== (x = o(2, U, R, n, S, j, B, f, d, f)) &&
                  0 === (U = x).length)
              )
                return G + U + $;
              if (((U = R.join(",") + "{" + U + "}"), 0 !== T * z)) {
        ...
        if (0 !== n) {
          ...
          if ((ml(), (e === kc && n === jc) || nl(e, n), null !== Cc)) {
            ...
            if ((Za(), (Ec = r), (yc.current = a), 1 === Sc))
              throw ((t = zc), nl(e, n), Ml(e, n), Xc(e), t);
            if (null === Cc)
              switch (
      ...
      function Zc(e) {
        ...
        if ((ml(), (e === kc && t === jc) || nl(e, t), null !== Cc)) {
          ...
          if ((Za(), (Ec = n), (yc.current = r), 1 === Sc))
            throw ((n = zc), nl(e, t), Ml(e, t), Xc(e), n);
        ...
        try {
          for (
            ...
            if (null !== c) {
              ...
              (n = t.unstable_now()),
                "function" === typeof l ? (N.callback = l) : N === j(T) && S(T),
                R(n);
            } else S(T);
            N = j(T);
          }
